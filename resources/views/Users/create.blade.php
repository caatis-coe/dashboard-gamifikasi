        ...
        <div class="bg-white shadow-lg rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('users.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="password" name="password_hash" class="w-full border rounded-lg p-2" required>
                </div>

                <div>
                    <label class="block text-gray-700 font-medium mb-1">Avatar URL (optional)</label>
                    <input type="url" name="avatar_url" class="w-full border rounded-lg p-2" placeholder="https://example.com/avatar.png">
                </div>
